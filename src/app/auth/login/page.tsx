...
function LoginForm() {
  ...
  const handleGoogleLogin = async () => {
    // Trigger Google OAuth flow via API route
    try {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface rounded-card border border-border shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="font-display text-2xl font-bold text-secondary mb-2">Welcome back</h1>
            <p className="text-sm text-text-secondary">
              Sign in to access your guides and points
            </p>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-border rounded-btn text-sm font-medium text-secondary hover:bg-background transition-colors duration-150 mb-6"
          >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-surface px-3 text-xs text-text-muted">or sign in with email</span>
            </div>
          </div>
